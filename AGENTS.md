...
- **詳細說明**：
  ...
  - **例外規則**：當使用者明確要求時，允許在程式碼中使用中文註解或文字
...
- **詳細說明**：
  ...
  - 當輸入字數為 4 時，僅當前兩個字符符合複姓對照表時才視為複姓雙名；否則仍採 1 字姓氏，其餘字符視為名字
  - 複姓對照表：万俟、萬俟、司馬、上官、歐陽、夏侯、諸葛、聞人、東方、赫連、皇甫、尉遲、公羊、澹臺、公冶、宗政、濮陽、淳于、單于、太叔、申屠、公孫、仲孫、軒轅、令狐、鍾離、宇文、長孫、慕容、鮮于、閭丘、司徒、司空、亓官、司寇、子車、顓孫、端木、巫馬、公西、漆雕、樂正、壤駟、公良、拓跋、夾谷、宰父、穀梁、段干、百里、東郭、南門、呼延、羊舌、微生、梁丘、左丘、東門、西門、南宮、第五
